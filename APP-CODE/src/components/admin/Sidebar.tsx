...
import {
  ...
  BookOpen, GraduationCap as GradIcon, ClipboardList, Calendar, CheckSquare, Award,
  PenTool, Upload, LifeBuoy, CalendarDays, Vote, TrendingUp as TrendUp, Link2,
  Smartphone, Bot, Server, Megaphone as Ads, Medal,
} from "lucide-react"
...
const navItems: { href: string; label: string; icon: React.ComponentType<{ className?: string }> }[] = [
  ...
  { href: "/app/training/centers", label: "Training Centers", icon: Building2 },
  { href: "/app/training/courses", label: "Courses", icon: FileText },
  { href: "/app/training/programs", label: "Programs", icon: ClipboardList },
  { href: "/app/training/enrollments", label: "Enrollments", icon: UserCheck },
  { href: "/app/training/apprenticeships", label: "Tr. Apprenticeships", icon: GradIcon },
  { href: "/app/training/attendance", label: "Attendance", icon: Calendar },
  { href: "/app/training/assessments", label: "Assessments", icon: CheckSquare },
  { href: "/app/training/examinations", label: "Examinations", icon: PenTool },
  { href: "/app/training/skills", label: "Skills", icon: Award },
  { href: "/app/training/certifications", label: "Certifications", icon: Award },
  { href: "/app/training/graduations", label: "Graduations", icon: GradIcon },
  { href: "/app/training/content", label: "Content", icon: Upload },
  { href: "/app/training/professional-development", label: "Prof. Dev.", icon: TrendingUp },
  { href: "/app/training/analytics", label: "Tr. Analytics", icon: BarChart3 },
  { href: "/app/training/audit", label: "Tr. Audit", icon: Shield },
  { href: "/app/training/settings", label: "Tr. Settings", icon: Settings },
  { href: "/app/events", label: "Events", icon: CalendarDays },
  { href: "/app/governance-enhanced", label: "Governance", icon: Vote },
  { href: "/app/support-hub", label: "Support Hub", icon: LifeBuoy },
  { href: "/app/analytics", label: "Analytics Hub", icon: TrendUp },
  { href: "/app/integration", label: "Integrations", icon: Link2 },
  { href: "/app/mobile", label: "Mobile PWA", icon: Smartphone },
  { href: "/app/ai-assistant", label: "AI Assistant", icon: Bot },
  { href: "/app/platform-ops", label: "Platform Ops", icon: Server },
  { href: "/app/advertising", label: "Advertising", icon: Ads },
  { href: "/app/tiering", label: "Tiering", icon: Medal },
