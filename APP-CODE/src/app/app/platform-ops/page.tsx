...
import {
  ChevronRight, Package, Users, FileText, Headphones,
  Handshake, Settings, ClipboardList,
} from "lucide-react"
...
const navCards: NavCard[] = [
  { title: "Subscription Plans", description: "Manage pricing plans", href: "/app/platform-ops/plans", icon: <Package className="h-5 w-5" /> },
  { title: "Subscriptions", description: "Tenant subscriptions", href: "/app/platform-ops/subscriptions", icon: <Users className="h-5 w-5" /> },
  { title: "Invoices", description: "Billing and invoicing", href: "/app/platform-ops/invoices", icon: <FileText className="h-5 w-5" /> },
  { title: "Support Tickets", description: "Tenant support requests", href: "/app/platform-ops/tickets", icon: <Headphones className="h-5 w-5" /> },
  { title: "Partners", description: "Platform partner management", href: "/app/platform-ops/partners", icon: <Handshake className="h-5 w-5" /> },
  { title: "Audit", description: "Platform operations logs", href: "/app/platform-ops/audit", icon: <ClipboardList className="h-5 w-5" /> },
  { title: "Settings", description: "Platform operations config", href: "/app/platform-ops/settings", icon: <Settings className="h-5 w-5" /> },
]
    ...
    <motion.div initial="hidden" animate="show" variants={containerVariants} className="space-y-6 pb-12">
      <motion.div variants={itemVariants}>
        <PageHeader
          ...
          description="Manage subscription plans, billing, support tickets, and partners."
          actions={
            <Link
              href="/app/dashboard"
