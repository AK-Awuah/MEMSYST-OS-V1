...
import {
  ChevronRight, Key, Webhook, Link2, Settings, ClipboardList,
  RefreshCw,
} from "lucide-react"
...
const navCards: NavCard[] = [
  { title: "API Keys", description: "Manage API access keys", href: "/app/integration/api-keys", icon: <Key className="h-5 w-5" /> },
  { title: "Webhooks", description: "Webhook endpoints and deliveries", href: "/app/integration/webhooks", icon: <Webhook className="h-5 w-5" /> },
  { title: "Integrations", description: "Third-party service integrations", href: "/app/integration/list", icon: <Link2 className="h-5 w-5" /> },
  { title: "Audit", description: "Integration activity logs", href: "/app/integration/audit", icon: <ClipboardList className="h-5 w-5" /> },
  { title: "Settings", description: "Integration configuration", href: "/app/integration/settings", icon: <Settings className="h-5 w-5" /> },
]
