...
import type { IntegrationAuditLog } from "@/types"
...
export default function IntegrationAuditPage() {
  ...
  const columns: Column<IntegrationAuditLog>[] = [
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Integration Audit Log" description="Track integration-related changes" />
