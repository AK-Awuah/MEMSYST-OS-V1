...
import type { TieringAuditLog } from "@/types"

export default function TieringAuditPage() {
  const [logs, setLogs] = useState<TieringAuditLog[]>([])
  ...
  const columns: Column<TieringAuditLog>[] = [
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Tiering Audit Log" description="Track tiering platform changes" />
