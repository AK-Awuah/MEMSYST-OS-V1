...
import {
  ChevronRight, Medal, Star, Eye, Settings, ClipboardList,
} from "lucide-react"
...
const navCards: NavCard[] = [
  { title: "Premium Accounts", description: "Manage premium tier accounts", href: "/app/tiering/accounts", icon: <Medal className="h-5 w-5" /> },
  { title: "Premium Listings", description: "Featured and boosted listings", href: "/app/tiering/listings", icon: <Star className="h-5 w-5" /> },
  { title: "Visibility Rules", description: "Search visibility and boost rules", href: "/app/tiering/rules", icon: <Eye className="h-5 w-5" /> },
  { title: "Audit", description: "Tiering activity logs", href: "/app/tiering/audit", icon: <ClipboardList className="h-5 w-5" /> },
  { title: "Settings", description: "Tiering configuration", href: "/app/tiering/settings", icon: <Settings className="h-5 w-5" /> },
]
  ...
  return (
    <motion.div initial="hidden" animate="show" variants={containerVariants} className="space-y-6 pb-12">
      <motion.div variants={itemVariants}>
        <PageHeader
          title="Tiering & Visibility Platform"
          description="Manage premium accounts, featured listings, and visibility rules."
          actions={
            <Link
              href="/app/dashboard"
