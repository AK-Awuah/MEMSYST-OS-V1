...
import {
  ChevronRight, Megaphone, BarChart3, Handshake, Settings, ClipboardList,
} from "lucide-react"
...
const navCards: NavCard[] = [
  { title: "Advertisements", description: "Manage ads and placements", href: "/app/advertising/ads", icon: <Megaphone className="h-5 w-5" /> },
  { title: "Campaigns", description: "Ad campaign management", href: "/app/advertising/campaigns", icon: <BarChart3 className="h-5 w-5" /> },
  { title: "Sponsors", description: "Sponsorship deal management", href: "/app/advertising/sponsors", icon: <Handshake className="h-5 w-5" /> },
  { title: "Audit", description: "Advertising activity logs", href: "/app/advertising/audit", icon: <ClipboardList className="h-5 w-5" /> },
  { title: "Settings", description: "Advertising configuration", href: "/app/advertising/settings", icon: <Settings className="h-5 w-5" /> },
]
    ...
    <motion.div initial="hidden" animate="show" variants={containerVariants} className="space-y-6 pb-12">
      <motion.div variants={itemVariants}>
        <PageHeader
          ...
          description="Manage ads, campaigns, and sponsorship deals."
          actions={
            <Link
              href="/app/dashboard"
