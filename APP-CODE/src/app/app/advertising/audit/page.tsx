...
import type { AdvertisingAuditLog } from "@/types"

export default function AdvertisingAuditPage() {
  const [logs, setLogs] = useState<AdvertisingAuditLog[]>([])
  ...
  const columns: Column<AdvertisingAuditLog>[] = [
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Advertising Audit Log" description="Track advertising platform changes" />
