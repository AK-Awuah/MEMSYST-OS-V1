...
import {
  ChevronRight, Bot, MessageSquare, BarChart3, Lightbulb, Settings, ClipboardList,
} from "lucide-react"
...
const navCards: NavCard[] = [
  { title: "Assistants", description: "Manage AI assistants", href: "/app/ai-assistant/assistants", icon: <Bot className="h-5 w-5" /> },
  { title: "Conversations", description: "View AI conversation logs", href: "/app/ai-assistant/conversations", icon: <MessageSquare className="h-5 w-5" /> },
  { title: "Smart Analytics", description: "AI-powered analytics", href: "/app/ai-assistant/analytics", icon: <BarChart3 className="h-5 w-5" /> },
  { title: "Suggestions", description: "Workflow automation suggestions", href: "/app/ai-assistant/suggestions", icon: <Lightbulb className="h-5 w-5" /> },
  { title: "Audit", description: "AI platform activity logs", href: "/app/ai-assistant/audit", icon: <ClipboardList className="h-5 w-5" /> },
  { title: "Settings", description: "AI platform configuration", href: "/app/ai-assistant/settings", icon: <Settings className="h-5 w-5" /> },
]
    ...
    <motion.div initial="hidden" animate="show" variants={containerVariants} className="space-y-6 pb-12">
      <motion.div variants={itemVariants}>
        <PageHeader
          ...
          description="Manage AI assistants, conversations, smart analytics, and workflow suggestions."
          actions={
            <Link
              href="/app/dashboard"
