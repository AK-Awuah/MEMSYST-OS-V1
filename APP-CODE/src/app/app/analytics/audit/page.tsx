...
import type { AnalyticsAuditLog } from "@/types"

export default function AnalyticsAuditPage() {
  const [logs, setLogs] = useState<AnalyticsAuditLog[]>([])
  ...
  const columns: Column<AnalyticsAuditLog>[] = [
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Analytics Audit Log" description="Track analytics-related changes" />
