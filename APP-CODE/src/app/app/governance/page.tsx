...
import { ChevronRight, Vote, Users, CalendarDays, BookCheck, BarChart4, ClipboardList, Settings } from "lucide-react"
...
const navCards: NavCard[] = [
  { title: "Governance Enhanced", description: "Full governance platform", href: "/app/governance-enhanced", icon: <Vote className="h-5 w-5" /> },
]
  ...
  return (
    <motion.div initial="hidden" animate="show" variants={containerVariants} className="space-y-6 pb-12">
      <motion.div variants={itemVariants}>
        <PageHeader
          title="Governance"
          description="Governance platform management."
          actions={
            <Link
              href="/app/dashboard"
