...
import { EVENTS_AUDIT_ACTIONS } from "@/lib/constants"
import { getEventsService } from "@/lib/services"
import type { EventsAuditLog } from "@/types"

export default function EventsAuditPage() {
  const [logs, setLogs] = useState<EventsAuditLog[]>([])
  ...
  const columns: Column<EventsAuditLog>[] = [
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Events Audit Log" description="Track all event-related changes" />
