...
export const mockTrainingCenters: TrainingCenter[] = [
  ...
  },
  {
    id: "tc-2",
    tenantId: "tenant-1",
    name: "Ghana Beauty & Style Institute",
    ownerId: "mem-3",
    ownerName: "Akua Manu",
    location: "Kumasi",
    contactInfo: "+233 20 100 0002",
    coursesOffered: ["Hair Styling", "Makeup Artistry", "Nail Technology"],
...
export const mockCourses: Course[] = [
  ...
  },
  {
    ...
    description: "Master modern hair styling techniques.",
    duration: "4 months",
    fees: 2000,
    level: "Beginner",
    status: "published",
  ...
  },
  {
    ...
    description: "Essential life-saving skills for all healthcare workers.",
    duration: "2 weeks",
    fees: 400,
    level: "Beginner",
    status: "draft",
...
export const mockPrograms: Program[] = [
  {
    ...
    description: "Comprehensive cardiac care program covering ACLS, ECG, and BLS.",
    levels: ["Beginner", "Intermediate", "Advanced"],
    requirements: ["Must be a registered member", "Valid medical license"],
    completionRules: ["Complete all required courses", "Pass final examination"],
    status: "active",
    createdAt: "2026-03-01T00:00:00Z",
    updatedAt: "2026-03-01T00:00:00Z",
  },
  {
    id: "prog-2",
    tenantId: "tenant-1",
    name: "Beauty & Cosmetology Mastery",
    description: "Full cosmetology program for aspiring beauty professionals.",
    levels: ["Beginner", "Intermediate", "Advanced", "Master"],
    requirements: ["Must be a registered apprentice"],
    completionRules: ["Complete all courses", "Portfolio review", "Practical assessment"],
    status: "active",
    createdAt: "2026-04-01T00:00:00Z",
    updatedAt: "2026-04-01T00:00:00Z",
  },
...
export const mockEnrollments: Enrollment[] = [
  ...
  },
  {
    ...
    tenantId: "tenant-1",
    learnerId: "app-1",
    learnerName: "Abena Ofori",
    courseId: "course-3",
    courseName: "Professional Hair Styling",
    source: "executive",
    status: "active",
    enrollmentDate: "2026-05-10T00:00:00Z",
    createdAt: "2026-05-10T00:00:00Z",
    updatedAt: "2026-05-10T00:00:00Z",
  },
  {
    ...
    tenantId: "tenant-1",
    learnerId: "mem-2",
    learnerName: "Ama Osei",
    courseId: "course-2",
    courseName: "ECG Interpretation Fundamentals",
    source: "self",
    status: "completed",
    enrollmentDate: "2026-03-01T00:00:00Z",
    completionDate: "2026-04-15T00:00:00Z",
    createdAt: "2026-03-01T00:00:00Z",
    updatedAt: "2026-04-15T00:00:00Z",
  },
]

export const mockApprenticeshipTrainings: ApprenticeshipTraining[] = [
  {
    id: "apt-1",
    tenantId: "tenant-1",
    apprenticeId: "app-1",
    apprenticeName: "Abena Ofori",
    mentorId: "mem-1",
    mentorName: "Kofi Ansah",
    trainingCenterId: "tc-2",
    programId: "prog-2",
    skillsAcquired: ["Basic Hair Cutting", "Shampooing"],
    progress: 35,
    status: "active",
    startDate: "2026-05-01T00:00:00Z",
    createdAt: "2026-05-01T00:00:00Z",
  ...
  },
  {
    ...
    tenantId: "tenant-1",
    apprenticeId: "app-2",
    apprenticeName: "Yaw Boateng",
    mentorId: "mem-3",
    mentorName: "Akua Manu",
    trainingCenterId: "tc-2",
    skillsAcquired: ["Nail Care", "Manicure"],
    progress: 60,
    status: "active",
...
export const mockAttendanceRecords: Attendance[] = [
  {
    ...
    learnerName: "Kofi Ansah",
    courseId: "course-1",
    session: "Week 1 - Introduction to ACLS",
  ...
  },
  {
    ...
    learnerName: "Kofi Ansah",
    courseId: "course-1",
    session: "Week 2 - Cardiac Anatomy",
...
export const mockExaminations: Examination[] = [
  {
    ...
    tenantId: "tenant-1",
    courseId: "course-2",
    title: "ECG Interpretation Final Exam",
  ...
  },
  {
    ...
    tenantId: "tenant-1",
    courseId: "course-1",
    title: "ACLS Mid-Term Assessment",
...
export const mockExaminationResults: ExaminationResult[] = [
  {
    id: "er-1",
...
export const mockSkills: Skill[] = [
  { id: "skill-1", tenantId: "tenant-1", name: "Hair Styling", category: "Cosmetology", createdAt: "2026-01-01T00:00:00Z" },
  { id: "skill-2", tenantId: "tenant-1", name: "Barbering", category: "Cosmetology", createdAt: "2026-01-01T00:00:00Z" },
  { id: "skill-3", tenantId: "tenant-1", name: "Makeup Application", category: "Cosmetology", createdAt: "2026-01-01T00:00:00Z" },
  { id: "skill-4", tenantId: "tenant-1", name: "Nail Technology", category: "Cosmetology", createdAt: "2026-01-01T00:00:00Z" },
  { id: "skill-5", tenantId: "tenant-1", name: "Cardiac Life Support", category: "Healthcare", createdAt: "2026-01-01T00:00:00Z" },
  { id: "skill-6", tenantId: "tenant-1", name: "ECG Interpretation", category: "Healthcare", createdAt: "2026-01-01T00:00:00Z" },
]

export const mockLearnerSkills: LearnerSkill[] = [
  {
    id: "ls-1", tenantId: "tenant-1", learnerId: "app-1", skillId: "skill-1", skillName: "Hair Styling",
    competencyLevel: "Intermediate", dateAchieved: "2026-05-15T00:00:00Z", verifiedBy: "mem-1",
    createdAt: "2026-05-15T00:00:00Z", updatedAt: "2026-05-15T00:00:00Z",
  },
  {
    id: "ls-2", tenantId: "tenant-1", learnerId: "app-1", skillId: "skill-2", skillName: "Barbering",
    competencyLevel: "Beginner", dateAchieved: "2026-05-20T00:00:00Z",
...
export const mockTrainingCertifications: TrainingCertification[] = [
  {
    ...
    expiresAt: "2028-04-20T00:00:00Z",
    createdAt: "2026-04-20T00:00:00Z",
    updatedAt: "2026-04-20T00:00:00Z",
  },
]
...
export const mockLearningContent: LearningContent[] = [
  {
    ...
    tenantId: "tenant-1",
    courseId: "course-1",
    title: "ACLS Algorithm Guide",
    description: "Step-by-step ACLS algorithm reference document.",
    contentType: "document",
    url: "/content/acls-algorithm.pdf",
    fileSize: 2048,
    status: "published",
    createdAt: "2026-03-15T00:00:00Z",
    updatedAt: "2026-03-15T00:00:00Z",
  },
  {
    ...
    tenantId: "tenant-1",
    courseId: "course-3",
    title: "Hair Styling Techniques Video",
    description: "Instructional video covering basic to advanced styling.",
    contentType: "video",
    url: "/content/hair-styling.mp4",
    fileSize: 150000,
    status: "published",
    createdAt: "2026-04-01T00:00:00Z",
    updatedAt: "2026-04-01T00:00:00Z",
...
export const mockProfessionalDevelopments: ProfessionalDevelopment[] = [
  {
    id: "pd-1",
    tenantId: "tenant-1",
    learnerId: "mem-1",
    ...
    skillsAchieved: ["Cardiac Life Support", "ECG Interpretation", "Medical Training"],
  ...
  },
  {
    ...
    skillsAchieved: ["Hair Styling", "Barbering"],
    professionalCredits: 15,
    updatedAt: "2026-06-01T00:00:00Z",
  },
]

export const mockTrainingAuditLogs: TrainingAuditLog[] = [
  {
    id: "taudit-1", tenantId: "tenant-1", actor: "Kofi Ansah",
    action: "course_created", recordType: "course", recordId: "course-1",
    details: "Created ACLS course", createdAt: "2026-04-01T00:00:00Z",
  },
  {
    id: "taudit-2", tenantId: "tenant-1", actor: "Ama Osei",
    action: "enrollment_approved", recordType: "enrollment", recordId: "enr-1",
    details: "Approved enrollment for ACLS", createdAt: "2026-04-15T00:00:00Z",
  },
  {
    id: "taudit-3", tenantId: "tenant-1", actor: "System",
    action: "attendance_recorded", recordType: "attendance", recordId: "att-1",
    details: "Marked present for Week 1", createdAt: "2026-04-20T00:00:00Z",
  },
]

export const mockTrainingSettings: TrainingSettings = {
  id: "ts-1",
  tenantId: "tenant-1",
  programs: ["Cardiac Care", "Beauty & Cosmetology"],
  levels: ["Beginner", "Intermediate", "Advanced", "Master"],
  assessmentRules: ["Minimum pass score: 70%", "Practical assessments mandatory for certification"],
  graduationRules: ["All courses completed", "All fees paid", "Assessment passed"],
  certificationRules: ["Valid for 2 years", "Renewable with continuing education credits"],
  accreditationRules: ["Annual inspection required", "Minimum 5 qualified instructors"],
